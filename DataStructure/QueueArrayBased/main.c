...
int main()
{
    ...
    Queue q;
    int choose_mode;
    printf("\t\t\t\t____________ choose one _____________ \n\n");
    printf("\t\t\t\t\t  1- For create Queue.\n");
    printf("\t\t\t\t\t  2- Append into queue.\n");
    printf("\t\t\t\t\t  3- Serve from queue.\n");
    printf("\t\t\t\t\t  4- check if queue is empty.\n");
    printf("\t\t\t\t\t  5- check if queue is full.\n");
    printf("\t\t\t\t\t  6- clear queue.\n");
    printf("\t\t\t\t\t  7- Get queue size.\n");
    printf("\t\t\t\t\t  8- Print queue's elements.\n");
    printf("\t\t\t\t\t  9- Exit.\n");
    ...
    switch (choose_mode)
    {
        ...
        case 6:
             ClearQueue(&q);
             printf("\t\t\t\t\t  Queue is cleared succecfully\n");
             break;
